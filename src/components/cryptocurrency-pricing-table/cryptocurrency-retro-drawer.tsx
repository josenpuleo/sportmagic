  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        ...
        >
          <div className="fixed inset-y-0 w-full max-w-full bg-white/95 shadow-[0_0_80px_rgba(17,24,39,0.2)] backdrop-blur dark:bg-dark/90 sm:w-[550px] md:w-[650px] lg:w-[800px] ltr:right-0 rtl:left-0">
