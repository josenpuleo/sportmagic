              ...
              <span className="flex flex-wrap items-center gap-[5px]">
                ...
                <span className="w-[70px]">
                  <Listbox value={selected} onChange={setSelected}>
                    <div className="relative rounded-lg bg-gray-100 px-3 text-sm font-medium text-brand dark:bg-gray-700 dark:text-white rtl:text-left">
                      <ListboxButton className="rounded-lg bg-gray-100 py-[5px] text-sm font-medium text-brand dark:bg-gray-700 dark:text-white">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <ListboxOptions className="absolute left-0 mt-3 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-large focus:outline-none dark:!bg-gray-700 sm:text-sm">
                          {currency.map((item) => (
                            <ListboxOption
                              key={item.id}
                              className={({ active }) =>
